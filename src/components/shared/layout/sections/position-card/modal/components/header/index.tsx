  ...
  return (
    <div className="bg-white pb-3 mb-5 px-2 border-b flex flex-col gap-y-3">
      ...
      <div className="flex-between w-full flex-wrap">
        ...
        <div className="flex-center gap-x-2 w-full md:w-fit">
          <button className="w-full md:w-fit text-white text-base font-semibold bg-blue-500 p-1 rounded-md transition-all hover:bg-blue-600">
            Apply now
          </button>
      ...
      <ul className="flex gap-x-2 flex-wrap gap-y-2">
