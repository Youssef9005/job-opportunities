...
export default function PositionCard({ positionName, techName }: PositionCardProps) {
  return (
    <div className="bg-gray-100 col-span-2 md:col-span-1 p-4 border rounded-md flex-1 flex flex-col gap-y-2">
      ...
      <div className="w-full flex-between">
        $2-7/hr
        <Button className="border border-main-color text-main-color transition-all hover:bg-main-color hover:text-white">
          Details
        </Button>
      </div>
    </div>
